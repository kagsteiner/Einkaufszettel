...
In jeder Kachel steht ein quadratisches Produktbild vollständig oberhalb der Informationen. Darunter folgen der höchstens zweizeilige Produktname, die Menge sowie eine einzeilige Notiz; die einmalige Einkaufsnotiz hat dabei Vorrang vor dem dauerhaften Produkthinweis. Ein eigenes Produktfoto hat Vorrang vor dem mitgelieferten Produktkatalog. Der Katalog trennt Bilddateien, echte Namenssynonyme und visuelle Produktknoten. Hat ein bekannter Produktknoten kein eigenes Bild, folgt die App seiner ausdrücklich visuellen `imageFallback`-Kette bis zum nächsten passenden Bild. Diese Kette bildet keine natürliche Produkthierarchie ab: Geriebener Mozzarella fällt etwa auf Reibekäse und nicht auf eine Mozzarellakugel zurück. Fehlt eine Namenszuordnung oder lässt sich keine Kette auflösen, erscheint das allgemeine Unbekannt-Bild. Das Antippen der Kachel hakt das Item ab und bestätigt dies kurz über dem Bild; ein getrennter Detailknopf öffnet die Bearbeitung. Erledigte Items stehen in beiden Ansichten in einem einklappbaren Bereich am Ende.
